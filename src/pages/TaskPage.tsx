    ...
    try {
      ...
      if (responseText.startsWith('http') && !responseText.includes('<') && !responseText.includes('{')) {
        ...
        try {
          ...
          } else if (urlMatch && urlMatch[0] && !urlMatch[0].includes('cloudflare') && !urlMatch[0].includes('5xx-error-landing')) {
      ...
      if (!link && result.html) {
        ...
        if (urlMatch && !urlMatch[0].includes('cloudflare') && !urlMatch[0].includes('5xx-error-landing')) link = urlMatch[0];
      }
